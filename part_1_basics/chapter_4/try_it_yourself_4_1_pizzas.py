...
print("I don't really remember " + pizzas[pizzas.index('calzone')].title() + \
", but there is one which is folded that is great!")
...
# list[list.index('nameofitem')] --> printing the name directly in the message
print("Fruit on pizzas like " + pizzas[1] + " is not something that I would \
recommend.")
