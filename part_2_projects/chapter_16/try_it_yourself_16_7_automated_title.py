...
# pulling out the number of earthquakes from the json file
# print(len(all_eq_dicts))
header_dict = all_eq_data['metadata']
...
for eq_dict in all_eq_dicts:
    ...
    # appending title to list hover_text
    print(mags[:10])
    # printing the first ten values
    print(lons[:5])
    print(lats[:5])

for eq_dict in header_dict:
header = eq_dict['metadata']['title']
...
my_layout = Layout(title=headers)
# adding a title
